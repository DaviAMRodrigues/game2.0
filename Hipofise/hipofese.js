...
image.src = './Hipofise/img/hipofisemap.png'

const foregroundImage = new Image()
foregroundImage.src = './Hipofise/img/hipofise.jpg'

const playerDownImage = new Image()
playerDownImage.src = './Hipofise/img/player.png'

const playerUpImage = new Image()
playerUpImage.src = './Hipofise/img/player.png'

const playerLeftImage = new Image()
playerLeftImage.src = './Hipofise/img/player.png'

const playerRightImage = new Image()
playerRightImage.src = './Hipofise/img/player.png'
