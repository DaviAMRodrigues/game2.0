...
const portal1Map = []
for (let i = 0; i < portal1.length; i+= 800) {
    portal1Map.push(portal1.slice(i, 800 + i))
}
...
playerDownImage.src = './img/player.png'

const playerUpImage = new Image()
playerUpImage.src = './img/player.png'

const playerLeftImage = new Image()
playerLeftImage.src = './img/player.png'

const playerRightImage = new Image()
playerRightImage.src = './img/player.png'
        ...
        if( moving != false) {
            ...
            for (let i = 0; i< portal01.length; i++) {
                ...
                if (
                    ...
                    newWeb()
                    loading(foregroundImage, image, playerRightImage, playerUpImage, playerDownImage, playerLeftImage)
                    break
                }
            }
